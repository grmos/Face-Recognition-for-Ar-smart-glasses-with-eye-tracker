...
ap.add_argument("-bvd", "--boolValidationData", type=int, default=1,
	help=" 0=>No validation data ,1=> Validation data")
...
ap.add_argument("-ms", "--modelsave", type=int, default=1,
	help=" True if you want to save the model after training")
ap.add_argument("-mp", "--modelpath", type=str, default="pretrained/classifier1.hdf5",
